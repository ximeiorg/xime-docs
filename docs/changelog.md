...
- **复杂表达式计算** - 计算器功能增强，支持完整表达式的实时评估计算
- **librime-octagram 和 librime-predict 集成** - 添加关联词预测和八词模型支持
- **Rime 引擎处理结果数据结构** - 添加新的引擎处理结果数据和功能
- **部署哈希验证机制** - 添加部署哈希验证机制优化配置管理
- **按键处理性能监控** - 增加维护超时时间并添加按键处理性能监控
- **多下载链接支持** - 方案市场索引支持多下载链接和改进镜像获取策略
- **无线导入文件上传优化** - 优化无线导入助手的文件上传处理
- **JNI 词典查询性能优化** - 调试构建中启用优化以提升词典查询性能

### 改进

- 更新 Rime 插件配置并修复插件复制逻辑
- 清空关联候选词当切换到英文模式
- 增加关联词数量限制常量并更新默认限制
- 优化阴影效果实现提升性能
- 修复候选页面布局问题
